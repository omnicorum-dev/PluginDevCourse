...
class Processor final : public juce::AudioProcessor {
  ...
  public:
    ...
    struct Params {
        ...
        // threshold (float)
        SCString thresh_ID       = "thresh";
        SCString thresh_name     = "Threshold";
        SCString thresh_suffix   = "";
        SCFloat  thresh_min      = 0.f;
        SCFloat  thresh_max      = 1.f;
        SCFloat  thresh_default  = 1.f;
        SCFloat  thresh_stepSize = 0.01f;
        SCFloat  thresh_skew     = 1.f;
