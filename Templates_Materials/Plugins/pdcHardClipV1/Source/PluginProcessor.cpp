...
//==============================================================================
PdcHardClipV1AudioProcessor::PdcHardClipV1AudioProcessor()
...
juce::AudioProcessorValueTreeState::ParameterLayout PdcHardClipV1AudioProcessor::createParameterLayout()
{
...
//==============================================================================
const juce::String PdcHardClipV1AudioProcessor::getName() const
{
    return JucePlugin_Name;
}

bool PdcHardClipV1AudioProcessor::acceptsMidi() const
{
...
bool PdcHardClipV1AudioProcessor::producesMidi() const
{
...
bool PdcHardClipV1AudioProcessor::isMidiEffect() const
{
   #if JucePlugin_IsMidiEffect
    return true;
   #else
...
double PdcHardClipV1AudioProcessor::getTailLengthSeconds() const
{
    return 0.0;
}

int PdcHardClipV1AudioProcessor::getNumPrograms()
{
    return 1;   // NB: some hosts don't cope very well if you tell them there are 0 programs,
                // so this should be at least 1, even if you're not really implementing programs.
}

int PdcHardClipV1AudioProcessor::getCurrentProgram()
{
    return 0;
}

void PdcHardClipV1AudioProcessor::setCurrentProgram (int index)
{
}

const juce::String PdcHardClipV1AudioProcessor::getProgramName (int index)
{
    return {};
}

void PdcHardClipV1AudioProcessor::changeProgramName (int index, const juce::String& newName)
{
}

//==============================================================================
void PdcHardClipV1AudioProcessor::prepareToPlay (double sampleRate, int samplesPerBlock)
{
    // =============================================================================
...
void PdcHardClipV1AudioProcessor::releaseResources()
{
...
#ifndef JucePlugin_PreferredChannelConfigurations
bool PdcHardClipV1AudioProcessor::isBusesLayoutSupported (const BusesLayout& layouts) const
{
  #if JucePlugin_IsMidiEffect
...
void PdcHardClipV1AudioProcessor::processBlock (juce::AudioBuffer<float>& buffer, juce::MidiBuffer& midiMessages)
{
...
//==============================================================================
bool PdcHardClipV1AudioProcessor::hasEditor() const
{
    return true; // (change this to false if you choose to not supply an editor)
}

juce::AudioProcessorEditor* PdcHardClipV1AudioProcessor::createEditor()
{
    return new juce::GenericAudioProcessorEditor(*this);
    //return new PdcHardClipV1AudioProcessorEditor (*this);
}

//==============================================================================
void PdcHardClipV1AudioProcessor::getStateInformation (juce::MemoryBlock& destData)
{
...
void PdcHardClipV1AudioProcessor::setStateInformation (const void* data, int sizeInBytes)
{
...
{
    return new PdcHardClipV1AudioProcessor();
}
