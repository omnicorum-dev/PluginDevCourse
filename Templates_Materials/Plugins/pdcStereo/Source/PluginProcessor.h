...
/**
*/
class PdcStereoAudioProcessor  : public juce::AudioProcessor
{
public:
    ...
    struct Params
    {
        ...
        */
        ...
        static constexpr const char* pan_ID     = "pan";
        static constexpr const char* pan_Name   = "Pan";
        static constexpr float pan_Min          = -1.0f;
        static constexpr float pan_Max          = 1.0f;
        static constexpr float pan_Default      = 0.0f;
        static constexpr float pan_StepSize     = 0.001f;
        static constexpr float pan_Skew         = 1.0f;
        
        static constexpr const char* width_ID     = "width";
        static constexpr const char* width_Name   = "Width";
        static constexpr float width_Min          = -1.0f;
        static constexpr float width_Max          = 1.0f;
        static constexpr float width_Default      = 0.0f;
        static constexpr float width_StepSize     = 0.001f;
        static constexpr float width_Skew         = 1.0f;
    ...
    juce::SmoothedValue<float> panSmooth;
    ...
    //==============================================================================
    PdcStereoAudioProcessor();
    ~PdcStereoAudioProcessor() override;
...
private:
    ...
    //==============================================================================
    JUCE_DECLARE_NON_COPYABLE_WITH_LEAK_DETECTOR (PdcStereoAudioProcessor)
};
