...
/**
*/
class PdcHardClipV2AudioProcessor  : public juce::AudioProcessor
{
public:
    ...
    //==============================================================================
    PdcHardClipV2AudioProcessor();
    ~PdcHardClipV2AudioProcessor() override;
...
private:
    ...
    //==============================================================================
    JUCE_DECLARE_NON_COPYABLE_WITH_LEAK_DETECTOR (PdcHardClipV2AudioProcessor)
};
